    ...
    namespace Cypress {
        interface Chainable<Subject = any> {
             ...
             * @example
              ...
              ```
             */
            stream: <T = any>(urlConfigOrSource: string | WebSocketSubjectConfig<T>) => Chainable<WebSocketSubject<T>>;
            /**
             ...
             * @example
              ...
              ```
             */
            streamRequest: <T = any>(urlConfigOrSource: string | WebSocketSubjectConfig<T>, streamOptions: Partial<StreamRequestOptions<T>>) => Chainable<T[] | void>;
        }
    }
}
